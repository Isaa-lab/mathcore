...
.mw-cols{display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;height:calc(100vh - 220px);min-height:520px}
...
export default function MistakeWorkbench({ supabase, userId, existingNotes = {} }) {
  ...
  return (
    <div className="mw">
      {weakness && <div className="mw-weak"><b>薄弱点分析：</b>{weakness}</div>}
